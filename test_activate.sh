...
export UNIRTM_GO_VERSION="1.26.2"
export UNIRTM_NPM__TAPLO_CLI_VERSION="0.7.0"
export UNIRTM_NPM_PNPM_VERSION="11.0.4"
...
export UNIRTM_GITHUB_GOOGLE_ADDLICENSE_VERSION="1.2.0"

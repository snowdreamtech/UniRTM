...
在您当前打开的 [.github/workflows/cd.yml](file:///Users/snowdream/Workspace/snowdreamtech/UniRTM/.github/workflows/cd.yml#L45-L62) 中，Harden Runner 的网络放行规则如下：
...
此操作将自动分析 `.mise.toml` 中所有的 Tools、Env 和 Settings，生成完美的 [.unirtm.toml](file:///Users/snowdream/Workspace/snowdreamtech/UniRTM/.unirtm.toml)（我们目前已经为您生成并提交了这一步）。

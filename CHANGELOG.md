...
* guard concurrency group pull_request context in pages workflow ([8d5987f](https://github.com/snowdreamtech/UniRTM/commit/8d5987f5be5184d5b1e2f32e2381c090e7772681))
* **tasks:** make osv-scanner recursive and resolve docs vulnerabilities ([6d42e80](https://github.com/snowdreamtech/UniRTM/commit/6d42e807933ee856d9eb1cb807443dc13b6031e1))
...
* add aurs distribution for Arch Linux (AUR) ([366c8e3](https://github.com/snowdreamtech/UniRTM/commit/366c8e34ebdd48135cb8e109fc42eb74e2b57e41))
...
* **cli:** add warning when built-in command shadows a user-defined task ([f28948b](https://github.com/snowdreamtech/UniRTM/commit/f28948b6355ec1a438450205231930cc2b3597ba))
...
* implement environment-aware vulnerability scanning with offline mode for local development ([0eb5c3f](https://github.com/snowdreamtech/UniRTM/commit/0eb5c3ff19e2a3972fcff3265b623f3cd0295ee0))
...
* implement semver-based version comparison in npm provider to improve version resolution accuracy ([1cacf98](https://github.com/snowdreamtech/UniRTM/commit/1cacf9803895dc4c7d4a502d5674ef55d2c7ac46))
...
* **install:** update default install directory to standard XDG/AppData paths ([dd9d825](https://github.com/snowdreamtech/UniRTM/commit/dd9d8258f3fbb97f0dd7a15934be90a82aa75645))
* **release:** add git.ignore_tags and release.prerelease: auto ([35dae4c](https://github.com/snowdreamtech/UniRTM/commit/35dae4c884b30f6d54045f70c7b8687ec4761cca))
* **release:** add gomod.proxy and metadata.mod_timestamp for reproducible builds ([51efe00](https://github.com/snowdreamtech/UniRTM/commit/51efe009262e38c847d01882a5221641f23e2bea))
* **release:** align build reproducibility and attestation with goreleaser project ([555dbf6](https://github.com/snowdreamtech/UniRTM/commit/555dbf60d1813ec0b7825dd0e32820d6e8335fe8))
...
* **task:** integrate mvdan.cc/sh for built-in cross-platform POSIX shell parsing ([35dcbdf](https://github.com/snowdreamtech/UniRTM/commit/35dcbdf1be5f21fb2e7cfe95905444db24df9d6a))
* **task:** support tasks without run property but with dependencies ([f12f38f](https://github.com/snowdreamtech/UniRTM/commit/f12f38f641d12bd506dc487a162b37bfcb41b9d3))
...
* **activate:** strictly use forward slashes and colons for POSIX scripts on Windows ([0bc3f3d](https://github.com/snowdreamtech/UniRTM/commit/0bc3f3debb8328812ecf12321e602df3168d307b))
* **activate:** use os.PathListSeparator for PowerShell scripts to support Linux/macOS pwsh ([eacdd51](https://github.com/snowdreamtech/UniRTM/commit/eacdd51662f9b43542c826569e36a4fbb2e8b442))
* **activation:** ensure shimsDir is appended to PATH for tools without bin paths ([a4c4852](https://github.com/snowdreamtech/UniRTM/commit/a4c4852e68acf2a39c2f4a4bb31a0872b705f655))
* **activation:** resolve path separator bugs for fish and posix scripts on windows ([7588ab3](https://github.com/snowdreamtech/UniRTM/commit/7588ab39228d13661fafd252181d161562bf0c85))
...
* add missing strings import in providers ([f2987cb](https://github.com/snowdreamtech/UniRTM/commit/f2987cb5d06e6787b9fcf0026646ccca8ead5aa2))
...
* adjust fallback windows zip asset matching score and exclusions, manually add shellcheck windows assets to lockfile [skip ci] ([17f60d7](https://github.com/snowdreamtech/UniRTM/commit/17f60d7abaf6409c6f287fbddb15cc6465f1b9f4))
...
* **backend:** mock git in TempDir to prevent asdf CI test leakage ([47b488c](https://github.com/snowdreamtech/UniRTM/commit/47b488c32e494cda6205c3fbf7197b5a2595eacf))
* **backend:** prevent darwin asset from matching Windows platform ([8abde29](https://github.com/snowdreamtech/UniRTM/commit/8abde29f308d4dd0acd8fd34b111e6b2da8d8356))
...
* **ci:** exclude lockfiles from end-of-file and whitespace auto-fixers ([b68fde7](https://github.com/snowdreamtech/UniRTM/commit/b68fde7c63509a4f7185b9290010e5dbad88579d))
* **ci:** fix cosign-installer action hash to verified v4.1.2 ([244ecff](https://github.com/snowdreamtech/UniRTM/commit/244ecff0b41d8d115fed2b16ea49c3131c32096c))
* **ci:** fix EACCES on attest step caused by flatpak-builder root-owned files ([41c33ce](https://github.com/snowdreamtech/UniRTM/commit/41c33ce4fead1e488e2d5d0d471f0ce3e5440501))
...
* **ci:** remove stale tools addlicense and pnpm to stabilize CI ([77f7c2f](https://github.com/snowdreamtech/UniRTM/commit/77f7c2f07b9e0711a1ded376216febb511b966f9))
* **ci:** remove verbose flag from test task [skip ci] ([36a0c4e](https://github.com/snowdreamtech/UniRTM/commit/36a0c4e5ecdc8c3ab7e3777dea75e7838a55a1b4))
...
* **ci:** use actions/attest with subject-checksums for SLSA ([ca518c6](https://github.com/snowdreamtech/UniRTM/commit/ca518c638ae3614b3ba65bc12a24e0972d6326ea))
...
* **cli:** verify currently executing binary after self-update instead of legacy path ([9a7f4c1](https://github.com/snowdreamtech/UniRTM/commit/9a7f4c14ccc3c700f8a881a360b8d08c8969019f))
...
* **cmd:** fix three Windows-specific test failures ([26c0a52](https://github.com/snowdreamtech/UniRTM/commit/26c0a5274c0063dd8ffb54a21933802929778248))
* **cmd:** inject unirtm dir into PATH for tasks and exec, add untrusted config hint ([4138f6d](https://github.com/snowdreamtech/UniRTM/commit/4138f6d4cae5a278b86daed503d5a862ae5d1a97))
* **cmd:** resolve pterm data race during testing ([f48853c](https://github.com/snowdreamtech/UniRTM/commit/f48853cd4f70e6bc662569d9b0ad8f4b88336c37))
* **cmd:** resolve test state leakage and flakiness ([1a1cf36](https://github.com/snowdreamtech/UniRTM/commit/1a1cf36b5e6d563fc480709ec23683d848d600dc))
...
* complete migration from brews to homebrew_casks ([8fcd23b](https://github.com/snowdreamtech/UniRTM/commit/8fcd23b317a72ddf010a05bedcb1af6edaf17b3d))
...
* **config:** replace POSIX shell commands with cross-platform python scripts in tasks ([8ed3adf](https://github.com/snowdreamtech/UniRTM/commit/8ed3adfb3bb5bdb57d40b809e2fc5b460fc171b8))
...
* **core:** close database handles to prevent locking on Windows ([6432754](https://github.com/snowdreamtech/UniRTM/commit/6432754b557320ab28ff53bc8c109589267361eb))
...
* correctly resolve native backend in lock and tool cmds [skip ci] ([1954967](https://github.com/snowdreamtech/UniRTM/commit/1954967d6448b6f9b7b5d37b351d037726b3fe9a))
...
* **docs:** approve esbuild in pnpm to resolve ERR_PNPM_IGNORED_BUILDS in ci ([50e8fa9](https://github.com/snowdreamtech/UniRTM/commit/50e8fa91227914e9207d806342b87fb931cbb804))
* **docs:** move overrides to devDependencies to resolve pnpm lockfile config mismatch ([18cc6e6](https://github.com/snowdreamtech/UniRTM/commit/18cc6e640cb7b8242ec3b576e7f2dbabade8782c))
* **docs:** resolve pnpm v11 ERR_PNPM_IGNORED_BUILDS by moving onlyBuiltDependencies to pnpm-workspace.yaml allowBuilds ([7bd64ec](https://github.com/snowdreamtech/UniRTM/commit/7bd64ecb25b68eafe3ec74d15b0840ba417535dd))
* **doctor:** resolve correct backend and gracefully check missing tool directories ([d950a24](https://github.com/snowdreamtech/UniRTM/commit/d950a243b4f1827cfd294d08a3899a1f1d001090))
...
* **env:** strictly use forward slashes and colons for POSIX PATH export on Windows ([90013b6](https://github.com/snowdreamtech/UniRTM/commit/90013b6ae6ba0b02f24243e5969bf3f5da968dea))
* **exec:** deduplicate PATH to prevent exponential explosion on Windows ([56e0fe1](https://github.com/snowdreamtech/UniRTM/commit/56e0fe16f1e4292a2be6a1c3944f17f99e4573a2))
...
* handle uppercase .EXE extension in isUniRTMBinary on Windows ([2e212e9](https://github.com/snowdreamtech/UniRTM/commit/2e212e93371d7258be1faba4b66c1d25ffc78ef2))
...
* **install:** combine output variables on a single line for read command ([dd9b3b3](https://github.com/snowdreamtech/UniRTM/commit/dd9b3b34b18ea4658b183d395492c827a6f7cba8))
...
* **install:** fix checksum matching and stdout pollution ([f0f3a8f](https://github.com/snowdreamtech/UniRTM/commit/f0f3a8fa9526f44c4affe2ae49d498d8a6889add))
* **install:** implement rollback mechanism on binary replacement failure ([db52e83](https://github.com/snowdreamtech/UniRTM/commit/db52e8328aa2e8c14f1ff2436a146e65de4769b2))
* **install:** prevent executable lock errors during self-update ([aedc5bc](https://github.com/snowdreamtech/UniRTM/commit/aedc5bcd85a060b30aac578dccd84e6368a07b2b))
* **install:** prevent subshell EXIT trap from deleting tmp dir before extraction ([e6bc3f5](https://github.com/snowdreamtech/UniRTM/commit/e6bc3f5bd834ea30d254d5da76defd9a9331ef2b))
...
* **lint:** remove trailing whitespace ([a94bae4](https://github.com/snowdreamtech/UniRTM/commit/a94bae4aaf67a3482cdc10eceb49d5ad5fe4b171))
* **lockfile:** ensure single trailing newline in unirtm.lock to satisfy pre-commit end-of-file-fixer ([1ff9f8c](https://github.com/snowdreamtech/UniRTM/commit/1ff9f8c580602bcd11a01d7abaa45cfad625b4ed))
* make all .exe extension checks case-insensitive for Windows support ([32ef17d](https://github.com/snowdreamtech/UniRTM/commit/32ef17da33e51c2ac541191135f72252ae956de3))
...
* match fallback windows/amd64 zip assets for tools like shellcheck [skip ci] ([0064ffb](https://github.com/snowdreamtech/UniRTM/commit/0064ffb9e948873f8d16552fbd10f23f4b1606db))
* migrate homebrew_casks to brews and fix emoji encoding in workflow ([204f617](https://github.com/snowdreamtech/UniRTM/commit/204f6176a2c17f6d89d1bc3f111027cc747da646))
* **npm:** inject node bin dir into PATH as Windows fallback safety net ([32ce045](https://github.com/snowdreamtech/UniRTM/commit/32ce045c6e152137c26807765614cdfd98979764))
* **npm:** properly replace entire IF EXIST block in Windows cmd wrappers using regex ([2aa562c](https://github.com/snowdreamtech/UniRTM/commit/2aa562c2bc585294c91cd1b5fea6126052006e26))
* **npm:** repair .cmd wrappers for already-installed tools on Windows ([8f4f5ba](https://github.com/snowdreamtech/UniRTM/commit/8f4f5ba02df19bbbd9aa16658b2ff55aa868455d))
* **npm:** rewrite Windows .cmd wrappers to use absolute node.exe path ([d525489](https://github.com/snowdreamtech/UniRTM/commit/d52548929abcd6c82de5285c4a03edd4f46f0996))
...
* **provider/python:** bypass Windows symlink DLL resolution issues (0xc0000135) ([86ebba7](https://github.com/snowdreamtech/UniRTM/commit/86ebba7ec4a22d7d98aead841f35ae1385b97300))
...
* **provider:** correct Node.js download URL extension for Windows ([252cccf](https://github.com/snowdreamtech/UniRTM/commit/252cccf8be600c927df4639948485c9a3a7587e1))
...
* **provider:** resolve python symlink on windows to prevent DLL missing error (0xc0000135) ([bdbcb91](https://github.com/snowdreamtech/UniRTM/commit/bdbcb9177309bf90ce416ed9ea052cf65ea1079e))
* **provider:** set GOTOOLCHAIN=local and prioritize tool-specific providers over native backend ([b936892](https://github.com/snowdreamtech/UniRTM/commit/b9368929f94dac63ecb487ab3d14589d296f2a3a))
* **pypi:** add install/python.exe to findPython candidates for Windows support ([0867612](https://github.com/snowdreamtech/UniRTM/commit/0867612cd2bc21b0602f6544aea9f58c4cfbe42a))
* **python:** remove isolated mode ._pth on Windows to fix venv error ([b0447ed](https://github.com/snowdreamtech/UniRTM/commit/b0447eda6488fafa9f772486499610a8953ecc3e))
...
* **release:** fix GPG signing error by switching to cosign ([dcc69f9](https://github.com/snowdreamtech/UniRTM/commit/dcc69f9af9cd8ef93d2de8c33c57eab90153601f))
* **release:** restore VERSION file tracking in release-please ([fab3d40](https://github.com/snowdreamtech/UniRTM/commit/fab3d409bd81d246b9c334e71d9dbe4a2ef00d93))
* **release:** restrict snapcraft release to stable channel ([4f5e974](https://github.com/snowdreamtech/UniRTM/commit/4f5e9741ea83335725bf0eb8bc989247ac75899c))
* **release:** switch cosign signing to bundle format ([ecf781f](https://github.com/snowdreamtech/UniRTM/commit/ecf781f22271732774881d0224843ef744610c4b))
...
* remove trailing whitespace causing pre-commit hook failure on CI ([8361c26](https://github.com/snowdreamtech/UniRTM/commit/8361c26c31b0754488402adb8f22a502a914e575))
* resolve archive name collision for macOS builds ([af5e88e](https://github.com/snowdreamtech/UniRTM/commit/af5e88e4ad2dd3a540512abf03d5a92626f89482))
...
* resolve installation and execution path issues ([b730c73](https://github.com/snowdreamtech/UniRTM/commit/b730c739c46d8b244b4a5c0bb8ea830a5fb4db80))
* resolve shellcheck, posix-sh and editorconfig failures in ci validation hooks ([428178a](https://github.com/snowdreamtech/UniRTM/commit/428178a70c5c48f6d313430422a93b5b02fec08a))
* resolve windows compatibility issues and test timeouts ([e8d3331](https://github.com/snowdreamtech/UniRTM/commit/e8d33318c7fdd891adc8ffe15e76c246582fd054))
* resolve zsh path cleaning and auto-activation hook logic bugs ([0288bb3](https://github.com/snowdreamtech/UniRTM/commit/0288bb36d7c6fba2f9af15be126ea1e0b0ff19d9))
...
* respect ENABLE_GITHUB_PROXY toggle when applying github proxy ([4c2b0ba](https://github.com/snowdreamtech/UniRTM/commit/4c2b0ba657197a21f6c3dbc6e201489d6ba6f7dc))
* **run:** fix hardcoded path separator and deduplicate PATH for tasks ([fc7d485](https://github.com/snowdreamtech/UniRTM/commit/fc7d485503eeeeb2b2cd6cbb5212258714a3172a))
* **self-update:** pass INSTALL_DIR via environment to ensure in-place upgrades ([d434417](https://github.com/snowdreamtech/UniRTM/commit/d434417312015cca39cda5ad80025e7d53fb0593))
...
* **self-update:** support GITHUB_PROXY for downloading install script ([bc7b680](https://github.com/snowdreamtech/UniRTM/commit/bc7b680f4cf0c3f6741e2d16caf9b5f487e6f5d5))
* **self-update:** use CompareVersions to prevent downgrading to older releases ([c8973de](https://github.com/snowdreamtech/UniRTM/commit/c8973de3b0e50c009dd54a8537c09c287ff3fcaa))
* **shim:** fallback to cmd shim on windows in tests to prevent access denied during tempdir cleanup ([1d88219](https://github.com/snowdreamtech/UniRTM/commit/1d88219acd9ab45c398af535b97bd92066e3670b))
* simplify pnpm onlyBuiltDependencies by using esbuild package name only ([8b98d6f](https://github.com/snowdreamtech/UniRTM/commit/8b98d6fc54deb3dda3a4c6098b86cb5362b82c3f))
...
* **tasks:** resolve dash syntax errors and osv-scanner binary resolution ([6adec1c](https://github.com/snowdreamtech/UniRTM/commit/6adec1ceb55e79016eea5f421208af4bf7b8db6b))
* **tasks:** resolve sh interpreter shadowing on windows ([faf773a](https://github.com/snowdreamtech/UniRTM/commit/faf773af4d4cdf2ee33e9c4eea35b200f1d885fa))
* **test:** add missing path/filepath import in install_test.go ([2861e5e](https://github.com/snowdreamtech/UniRTM/commit/2861e5e4b09488378d9d95ecdd5d7f34d9458e84))
* **test:** add missing runtime import in edit_test.go ([953234b](https://github.com/snowdreamtech/UniRTM/commit/953234bfa3d3ed299fe174bdb5e77cf9c28ac817))
* **test:** add timeout to task --list-all execution to prevent hang ([ab53901](https://github.com/snowdreamtech/UniRTM/commit/ab53901ddbb523f6d9f541c365905fcf63803309))
...
* **test:** fix environment leakage and git config issues in CI tests ([744af3e](https://github.com/snowdreamtech/UniRTM/commit/744af3e13ddc04b539154a35dbcef93cc39524c7))
* **test:** import missing runtime package in github token tests ([77a8c7c](https://github.com/snowdreamtech/UniRTM/commit/77a8c7c5956ade58d81b5a59c70ab34e5e7320bc))
...
* **test:** remove -race flag to support CGO_ENABLED=0 ([7af763a](https://github.com/snowdreamtech/UniRTM/commit/7af763a03d2cbfa839dfac610c652d7b7593fa2d))
* **test:** remove addlicense and pnpm references from test_activate.sh snapshot ([30ef2d3](https://github.com/snowdreamtech/UniRTM/commit/30ef2d3cc3901b50c8d9a24b171d90356e2eeab0))
* **test:** replace log.Fatal with fmt.Println in example tests to prevent silent process exit on failure [skip ci] ([36e7b07](https://github.com/snowdreamtech/UniRTM/commit/36e7b07c112df7075c1b9a11c9e716a9c7e17fea))
* **test:** resolve remaining windows test failures ([711ccd6](https://github.com/snowdreamtech/UniRTM/commit/711ccd6bcf26aa1f55835a1fbeed9aa618902bff))
* **test:** resolve windows CI test failures [skip ci] ([c5393a0](https://github.com/snowdreamtech/UniRTM/commit/c5393a085338c4899059b37ed7ec78c1cf0eeb10))
* **test:** resolve windows test failures ([463472e](https://github.com/snowdreamtech/UniRTM/commit/463472e17c6028baa6264825d520ea1bca6dba7a))
* **test:** revert mcp test assertion to expect nil error ([27c7849](https://github.com/snowdreamtech/UniRTM/commit/27c78491e6b5cb3a5e0f943c74819495cb941709))
* **test:** use require to prevent panic on empty array in ruby tests and fix isMatch linux assertion ([84a444c](https://github.com/snowdreamtech/UniRTM/commit/84a444cdffd08493e09c9d64cf70babb0324c9ca))
* trigger new version release to run full CI/CD ([fdcbd06](https://github.com/snowdreamtech/UniRTM/commit/fdcbd06a00b18139442839207fb256f4827f98d9))
...
* update flatpak app_id to io.github.snowdreamtech.UniRTM ([0cda955](https://github.com/snowdreamtech/UniRTM/commit/0cda955de754e4bda2c987284274110fee1d2066))
...
* **npm:** optimize cmd wrapper rewrite to skip unnecessary disk writes ([7b6a1c3](https://github.com/snowdreamtech/UniRTM/commit/7b6a1c3ee834970a34275ce2393395c670ffc73e))

## [0.17.0](https://github.com/snowdreamtech/UniRTM/compare/v0.16.1...v0.17.0) (2026-06-10)
...
## [0.15.1](https://github.com/snowdreamtech/UniRTM/compare/v0.15.0...v0.15.1) (2026-06-10)
...
## [0.14.0](https://github.com/snowdreamtech/UniRTM/compare/v0.13.0...v0.14.0) (2026-06-09)
...
## [0.13.0](https://github.com/snowdreamtech/UniRTM/compare/v0.12.0...v0.13.0) (2026-06-09)
...
## [0.10.0](https://github.com/snowdreamtech/UniRTM/compare/v0.9.0...v0.10.0) (2026-06-08)

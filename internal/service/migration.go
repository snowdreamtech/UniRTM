...
func (mm *MigrationManager) MigrateFile(ctx context.Context, sourcePath string, outputPath string, dryRun bool) (*MigrationReport, error) {
	...
	content := mm.generateUnirtmConfig(tools, outputPath)
...
// generateUnirtmConfig generates a UniRTM configuration from a list of tools.
// Output format is determined by the file extension of outputPath.
//
// Validates Requirements: 21.3, 21.5
func (mm *MigrationManager) generateUnirtmConfig(tools []MigrationTool, outputPath string) string {

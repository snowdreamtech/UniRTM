...
printf '%s\n' '       for pkg in npm/unirtm-*/; do npm publish "$pkg" --access public --provenance --registry=https://registry.npmjs.org; done'
printf '  2. Then publish root package:\n'
printf '       npm publish npm/unirtm/ --access public --provenance --registry=https://registry.npmjs.org\n'
